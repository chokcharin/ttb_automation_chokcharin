...
Resource    ${CURDIR}/../../../keyword/web/common.robot
Resource    ${CURDIR}/../../../resource/web/localization/herokuapp/login.robot
Resource    ${CURDIR}/../../../resource/web/locator/herokuapp/login.robot
